                        ...
                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                            <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="/detil-persubopd/{{ $row->kode_opd }}" class="text-dark"
                                                data-bs-container="#tooltip-container2" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="Klik angka untuk melihat rincian per Sub OPD">{{ ++$i
                                                }}</a></td>
                                        <td><a href="/detil-persubopd/{{ $row->kode_opd }}" class="text-dark"
                                                data-bs-container="#tooltip-container2" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                        ...
                                        <td class="text-end"><a href="/detil-persubopd/{{ $row->kode_opd }}"
