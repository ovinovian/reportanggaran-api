    ...
    <div class="col">
      <table id="data-table" class="table table-striped table-hover table-sm">
        <thead>
          <tr>
            <th>No</th>
            {{-- <th scope="col">Kode SKPD</th> --}}
            <th scope="col">Nama SKPD</th>
            {{-- <th scope="col">Kode Sub SKPD</th> --}}
            ...
            <th scope="col">Periode SPD</th>
            <th scope="col">Nilai Detail SPD</th>
            <th scope="col">Sisa Detail SPD</th>
            <th scope="col">Tahap SPD</th>
            <th scope="col">Sub Tahap SPD</th>
            <th scope="col">Status Tahap SPD</th>
            <th scope="col">Dokumen</th>
            <th scope="col">Jenis</th>
            <th scope="col">Nomor Dokumen</th>
            <th scope="col">Nomor LPJ</th>
            <th scope="col">Status LPJ</th>
            <th scope="col">Tanggal Simpan</th>
            <th scope="col">Tanggal Dokumen</th>
            <th scope="col">Bulan Dokumen</th>
            <th scope="col">Keterangan Dokumen</th> --}}
            <th scope="col">Nilai Realisasi</th>
            {{-- <th scope="col">Nilai Setoran</th> --}}
            {{-- <th scope="col">User Dokumen</th> --}}
            {{-- <th scope="col">Pegawai Dokumen</th>
            <th scope="col">Nomor SPP</th>
            <th scope="col">Tanggal SPP</th>
            <th scope="col">Nomor SPM</th>
            <th scope="col">Tanggal SPM</th>
            <th scope="col">Nomor SP2D</th>
            <th scope="col">Nilai SP2D</th>
            <th scope="col">Tanggal SP2D</th>
            <th scope="col">Periode</th>
            <th scope="col">Nilai Realisasi LRA</th>
            <th scope="col">Nomor SPP GU</th>
            <th scope="col">Tanggal SPP GU</th> --}}
          </tr>
        </thead>
        <tbody></tbody>
      </table>
